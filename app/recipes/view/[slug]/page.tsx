 ...
 *,
 ...
 if (error || !recipe) {
 return (
 <main className="flex flex-col items-center justify-center min-h-[60vh] p-10 text-center text-black dark:text-white">
 ...
 <summary className="text-xs cursor-pointer text-gray-500 dark:text-gray-400">Ver detalle técnico (Solo Dev)</summary>
 <pre className="text-[10px] bg-gray-50 dark:bg-gray-800 p-2 rounded mt-2 overflow-auto">
 ...
 <article className="bg-white dark:bg-gray-900 border rounded-3xl shadow-sm overflow-hidden">
 {recipe.image_url && (
 ...
 : 'bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-gray-800'
 }`}>
 ...
 <div>
 <p className="text-sm text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider mb-0.5">{t.recipes.author}</p>
 <div className="flex items-center gap-2">
 <Link
 href={`/user/${recipe.profiles?.username}/recipes`}
 className="text-gray-900 dark:text-gray-100 hover:text-orange-600 font-bold text-lg transition-colors"
 >
 ...
 <div className="bg-white dark:bg-gray-900 px-2 py-1 rounded-[2rem] border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col items-center md:items-end gap-1">
 <RatingDisplay
 itemId={recipe.id}
 tableName="recipe_reviews"
 size={20}
 ...
 <div className='flex items-center gap-3 bg-gray-50 dark:bg-gray-800 px-3 py-1.5 rounded-2xl border border-gray-100 dark:border-gray-800'>
 {/* Duración */}
 <div className='flex items-center gap-1.5 text-gray-600 dark:text-gray-300 border-r border-gray-200 dark:border-gray-700 pr-3'>
 ...
 <h2 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">{t.global.description}</h2>
 </div>
 ...
 <h2 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">{t.global.ingredients}</h2>
 </div>
 ...
 <div
 key={index}
 className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 hover:bg-white dark:bg-gray-900 hover:shadow-md transition-all group"
 >
 <CheckCircle2 size={18} className="text-orange-400 group-hover:text-orange-600 transition-colors" />
 <span className="text-gray-700 dark:text-gray-300 font-medium">{ing.trim()}</span>
 </div>
 ))}
 </div>
 </section>
 ...
 <h2 className="text-xl font-black text-gray-900 dark:text-gray-100 uppercase tracking-tight">{t.global.instructions}</h2>
 </div>
