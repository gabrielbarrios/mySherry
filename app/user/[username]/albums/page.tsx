    ...
    return (
        <main className="p-6 max-w-7xl mx-auto text-black">
            ...
            <div className="flex justify-between items-end mb-8">
                ...
                <span className="text-sm text-gray-500">{count || 0} {t.albums.found}</span>
            </div>
                    ...
                    {albums?.map((album) => {
                        ...
                        return (
                            <section key={album.id}>
                                ...
                                <div className="flex flex-col md:flex-row md:items-end justify-between gap-3 mb-5">
                                    <div>
                                        <Link
                                            ...
                                            className="text-2xl font-black text-gray-900 hover:text-orange-600 transition-colors tracking-tight"
                                        >
                                            {album.title}
                                        </Link>
                                        {album.description && (
                                            <p className="text-gray-500 text-sm italic mt-1">{album.description}</p>
                                        )}
                                ...
                                {/* Photo grid */}
                                {photos.length === 0 ? (
                                    <div className="h-40 bg-gray-50 rounded-3xl flex items-center justify-center border-2 border-dashed border-gray-100">
                ...
                <nav className="flex justify-center items-center gap-3 mt-16">
                    {page > 1 ? (
                        <Link
                            ...
                            className="flex items-center gap-1.5 px-4 py-2.5 bg-white border border-gray-200 rounded-2xl text-sm font-bold text-gray-600 hover:bg-gray-50 transition-all"
                        >
