...
export default async function UserProfilePage({
 ...
 <div className="w-32 h-32 bg-gray-100 dark:bg-gray-800 rounded-full mb-4 border-4 border-white shadow-xl overflow-hidden flex items-center justify-center">
 {profile.avatar_url ? (
 ...
 {profile.biography && (
 <p className="text-gray-500 dark:text-gray-400 max-w-sm italic">"{profile.biography}"</p>
 )}
 ...
 <div className="mt-8">
 <h3 className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-4">Intereses</h3>
