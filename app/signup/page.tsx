...
export default function SignupPage() {
 ...
 return (
 <div className="flex flex-col gap-6 p-10 max-w-md mx-auto border rounded-xl shadow-sm mt-10 bg-white dark:bg-gray-900">
 <h1 className="text-3xl font-bold text-center text-orange-600">Chef Registration</h1>

 <form onSubmit={handleSignUp} className="flex flex-col gap-4 text-black dark:text-white">
