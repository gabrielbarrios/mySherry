...
export default function RestaurantFormFields({
 ...
 return (
 <div key={day.id} className={`p-4 rounded-3xl border transition-all ${isClosed ? 'bg-gray-50 dark:bg-gray-800 opacity-60' : 'bg-white dark:bg-gray-900 border-purple-100 shadow-sm'}`}>
 <div className="flex justify-between items-center mb-3">
 <span className="text-xs font-black uppercase tracking-widest text-gray-500 dark:text-gray-400">{day.label}</span>
 ...
 />
 <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase">{t.global.closed}</span>
 </label>
 </div>
