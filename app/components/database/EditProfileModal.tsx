        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-in zoom-in duration-200">
                <div className="flex justify-between items-center p-6 border-b border-gray-50">
                    <h2 className="text-xl font-black text-gray-900 uppercase tracking-tight">Editar Perfil</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[75vh] space-y-6">
                    ...
                    <div>
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4">Intereses</p>
                            ...
                            {INTEREST_OPTIONS.map(opt => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-xl text-xs font-bold transition-all border ${isSelected ? 'bg-orange-500 border-orange-500 text-white shadow-md' : 'bg-gray-50 border-gray-100 text-gray-500 hover:border-gray-200'}`}
                                    >
                                        {opt.label}
                                    </button>
                                )
