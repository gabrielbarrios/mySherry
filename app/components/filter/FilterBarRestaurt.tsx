...
export default function FilterBarRestaurant({ params }: Props) {
    ...
    return (
        <section className="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm mb-12">
            <Heading level="h2" className="mb-6 text-gray-400">{t.global.filter}</Heading>
            ...
            <form method="GET" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="flex items-end gap-2 lg:col-span-3 lg:justify-end">
                    ...
                    <Link href={pathname} className="flex-1 lg:flex-none p-4 bg-gray-100 text-gray-400 rounded-2xl hover:bg-gray-200 transition-all flex items-center justify-center group">
