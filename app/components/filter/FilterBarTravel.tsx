...
import { Search, Tag, Globe, Banknote, Eraser } from 'lucide-react';
...
export default function FilterBarTravel({ params }: Props) {
 ...
 <div>
 <FormInput
 label={t.travels.destinationCountry}
 id="country"
 name="country"
 defaultValue={params.country}
 placeholder={t.travels.placeholder.country}
 icon={Globe}
 />
 </div>

 <div className="flex flex-col gap-2" key={params.budget}>
 <FormInput
