        ...
        <main className="max-w-7xl mx-auto px-6 py-12">
            ...
            {friends.length === 0 ? (
                <div className="mt-20 text-center space-y-4">
                    ...
                    <p className="text-gray-500">{t.friends.findFriends}</p>
                    <Link href="/" className="inline-block bg-black text-white px-8 py-3 rounded-full font-bold text-sm hover:scale-105 transition-transform">
