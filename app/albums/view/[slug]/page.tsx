 ...
 *,
 ...
 <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">{t.albums.notFound}</h1>
 <p className="text-gray-500 dark:text-gray-400 max-w-md mb-8 leading-relaxed">{t.albums.notFoundMessage}</p>
 ...
 <Link href="/albums" className="bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 text-gray-700 dark:text-gray-300 font-bold py-3 px-6 rounded-xl transition-all active:scale-95">
 {t.albums.myAlbums}
 </Link>
 </div>
 </main>
 ...
 <div>
 <Link href={`/user/${ownerProfile?.username}/albums`} className="font-bold text-gray-900 dark:text-gray-100 hover:text-orange-600 transition-colors">
 ...
 <div className="bg-white dark:bg-gray-900 px-4 py-2 rounded-2xl border border-gray-100 dark:border-gray-800 flex items-center gap-3 ml-2">
 ...
 <span className={`text-[10px] font-black uppercase px-3 py-1.5 rounded-xl border ${album.permission === 0 ? 'bg-green-50 text-green-700 border-green-100' :
 ...
 {/* Photo gallery */}
 <section className="bg-white dark:bg-gray-900 p-8 rounded-[3rem] border border-gray-100 dark:border-gray-800 shadow-sm">
 ...
 {photos.length === 0 ? (
 <p className="text-gray-500 dark:text-gray-400 italic text-center py-12">{t.albums.noPhotos}</p>
 ) : (
 ...
 />
 <div className="absolute inset-0 bg-black/0 dark:bg-gray-950/0 group-hover:bg-black/20 dark:bg-gray-950/20 transition-colors" />
 </a>
 ))}
 </div>
 )}
